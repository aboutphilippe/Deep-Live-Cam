...
def webcam_preview():
    ...
    cap.set(cv2.CAP_PROP_FRAME_WIDTH, 490)  # Set the width of the resolution
    cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 270)  # Set the height of the resolution
    cap.set(cv2.CAP_PROP_FPS, 25)  # Set the frame rate of the webcam
    PREVIEW_MAX_WIDTH = 490
